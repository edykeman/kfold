...
! ==============================================================================
      ...
      SUBROUTINE TDANGLE3 (LIST,ES)
        ...
        DATA (au(i),i=1,4) / -0.80e0,-0.50e0,-0.80e0,-0.60e0 /

        DATA (cg(i),i=1,4) / -1.70e0,-0.80e0,-1.70e0,-1.20e0 /

        DATA (gc(i),i=1,4) / -1.10e0,-0.40e0,-1.30e0,-0.60e0 /

        DATA (ua(i),i=1,4) / -0.70e0,-0.10e0,-0.70e0,-0.10e0 /

        DATA (gu(i),i=1,4) / -0.80e0,-0.50e0,-0.80e0,-0.60e0 /

        DATA (ug(i),i=1,4) / -0.70e0,-0.10e0,-0.70e0,-0.10e0 /
